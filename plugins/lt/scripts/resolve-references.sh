...
# (${CLAUDE_PLUGIN_ROOT}/scripts/ resolve antes de mirrors).
#
# Uso:
#   bash ${CLAUDE_PLUGIN_ROOT}/scripts/resolve-references.sh <skill-name> <files...>
#   echo "<diff text>" | bash ... <skill-name> <files...>
#
# Variaveis:
#   AGENTS_ROOT          raiz onde skills/<skill> resolve (default: CLAUDE_PLUGIN_ROOT, senao pwd).
...
#   2. Senao, walk-up a partir do arquivo procurando .lt/ ou .git/ — usa
