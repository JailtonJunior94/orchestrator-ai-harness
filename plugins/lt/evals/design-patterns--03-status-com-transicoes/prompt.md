O Order.java em evals/fixtures/orders está cheio de if por status e vamos ganhar os status RETURNED e REFUNDED. Como organizo isso?

O repositório não está disponível nesta sessão; o conteúdo atual dos arquivos citados vai abaixo.

`evals/fixtures/orders/Order.java`:
