...
## Metadados
- **PRD:** `.lt/specs/prd-[nome-da-funcionalidade]/prd.md`
- **Especificação Técnica:** `.lt/specs/prd-[nome-da-funcionalidade]/techspec.md`
- **Total de tarefas:** X
...
<!-- Colunas e formato canônico (MANDATÓRIO):
     ...
     - `Skills`: skills processuais extras (descoberta agnóstica em `${CLAUDE_PLUGIN_ROOT}/skills/`). Use `—` quando
