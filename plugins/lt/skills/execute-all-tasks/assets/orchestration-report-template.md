...
## PRD
- Slug: <slug>
- Diretório: .lt/specs/prd-<slug>/
- PRD: .lt/specs/prd-<slug>/prd.md
- TechSpec: .lt/specs/prd-<slug>/techspec.md
- Tasks: .lt/specs/prd-<slug>/tasks.md
...
|---|--------|--------|-------------|---------|
| <id> | <título> | <status> | .lt/specs/prd-<slug>/<id>_execution_report.md | <1-line summary do subagent> |
